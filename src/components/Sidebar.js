      ...
      <div className="siderContent">
        <div className="menu">
          <div className="details">
            <Icon fill="#ffffff" size={100} svg="bell" color="black" />
          </div>
        ...
        <div className="howto">
          <div className="msg">
          Each SIGNAL costs 1 tMATIC. Get tMATIC for free at the faucet: mumbaifaucet.com Add Polygon TestNet to your wallet and send your Signals ヅ
          </div>
       </div>
